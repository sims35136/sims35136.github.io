...
function start() {
  ...
  const gameOver = () => {
    endScreen.innerHTML = `<div class="gameOver"> Fin du jeu, tu as lamentablement échoué <br/>score : ${count} </div>`;
  ...
  const youWin = () => {
    ...
    endScreen.innerHTML = `<div class="youWin"> Tu as réussi petit padawan ! <br/><span>Accuarcy: ${accuracy} %</span></div>`;
    endScreen.style.visibility = 'visible';
    endScreen.style.opacity = '1';
    loopPlay = false; 
  };
